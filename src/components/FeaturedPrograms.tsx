              ...
              {displayPrograms.map((p, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`shrink-0 bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm hover:shadow-2xl hover:border-burgundy/30 transition-all duration-500 group relative overflow-hidden depth-card ${
                      isExpanded ? "w-[650px] sm:w-[700px]" : "w-[300px] sm:w-[350px] md:w-[360px]"
                    }`}
                  >
                    <div className="flex items-start gap-6">
                      {/* Left Column: Primary Course Card Details & Actions */}
                      <div className="w-[280px] sm:w-[300px] shrink-0 flex flex-col justify-between min-h-[220px]">
                        <div>
                      ...
                      {/* Right Column: Horizontal Expanded Details Panel */}
                      <AnimatePresence>
                        {isExpanded && (
                          <motion.div
                            ...
                            transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }}
                            className="overflow-hidden border-l border-[#E2E8F0] pl-6 space-y-4 shrink-0 w-[300px] sm:w-[330px]"
                          >
                            {/* Eligibility */}
                            <div>
